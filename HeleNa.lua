...
if hash or Bot(msg) or DevLaricA(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or VIP_DeV(msg) then        
return true    
else    
return false    
end 
...
if hash or Bot(msg) or  DevLaricA(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) or VIP_DeV(msg) then        
return true 
else 
return false 
end 
...
local get_id = database:get(bot_id.."LaricA:Klesh:Id:Bot"..msg.chat_id_)
if not database:get(bot_id..'LaricA:Lock:ID:Bot:Photo'..msg.chat_id_) then
...
os.execute('wget https://raw.githubusercontent.com/LARICATEAM/HeleNa/master/LaricA.lua')
os.execute('wget https://raw.githubusercontent.com/LARICATEAM/HeleNa/master/start.lua')
dofile('LaricA.lua')  
return false
end
if text == "راسلني" then
...
Srrt = https.request('https://LaricA-source.tk/MALATHSOURCE/ImageInfo.php?token='..token..'&url='..photo_id.."&type=photo")
...
if DevLaricA(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/MALATHSOURCE/files_LaricA/master/getfile.json")
if res == 200 then
